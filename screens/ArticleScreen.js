...
import { View, Screen, TextInput, Text, Title, Button, Image, Icon, Row, ScrollView, Heading, Caption, Divider } from "@shoutem/ui";
    ...
    return (
      <ScrollView>
        <View style={styles.container2}>
          ...
          <Image styleName="large-square" source={{ uri: image }} />
